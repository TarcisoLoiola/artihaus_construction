    ...
    return (
        ...
        <div className='page-content-container'>
          <div className='our-commitment--describe'>
            ...
            <p className="u-p u-color-gray">What sets us apart is not just our quality and attention to detail, but our hands-on approach. We are fully present throughout the entire process, ensuring commitment and responsibility.</p>
          </div>
