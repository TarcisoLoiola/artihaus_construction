      ...
      <section className='our-commitment backgroundColor-lightgray'>
        <div className='page-content-container'>
          <div className='our-commitment--describe flex-row marginBottom-lg'>
            <h1 className="h1 color-blue flex-1">Our commitment to quality and excellence.</h1>
            <p className="p color-gray marginTop-sm flex-1">What sets us apart is not just our quality and attention to detail, but our hands-on approach. We are fully present throughout the entire process, ensuring commitment and responsibility.</p>
          </div>
